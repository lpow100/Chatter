...
def make_cmd(cmds)->list[str]:
        ...
        for cmd in cmds:
            ...
            cur += cmd
        if is_str:
            cprint(f"[#B00020]Error: {cmds}\nIs missing quotes please use help for help[#B00020]",file=sys.stderr)
...
while True:
    try:
        ...
        if cmd[0] == "help":
            ...
            cprint(f"[#B00020]Error: {cmd}\nIs not a valid command please use help for help[#B00020]",file=sys.stderr)
